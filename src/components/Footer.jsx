    ...
    <div className="w-full h-screen flex justify-between bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8vw] uppercase font-semibold leading-none mb-1">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase font-semibold leading-none -mb-11">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] uppercase font-semibold leading-none mb-1">
          Presentations
        </h1>
